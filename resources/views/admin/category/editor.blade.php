                  ...
                  <div class="card-body">
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="cat_name" class="form-control" value="{{ str_contains($url, 'edit') ? $category->category_name : '' }}">
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Category Slug</label>
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="cat_slug" class="form-control" value="{{ str_contains($url, 'edit') ? $category->category_slug : '' }}">
                      </div>
                    </div>
                    <div class="form-group row mb-4">
